          ...
          {incidents.length === 0 ? (
            ...
            incidents.map((incident) => (
              <tr
                ...
                className={`cursor-pointer transition-all hover:shadow-md ${getSeverityColor(incident.severity)
              ...
              >
                ...
                <td className="px-4 py-3">
                  <span className={`px-2 py-1 rounded text-sm ${incident.status === 'Active'
