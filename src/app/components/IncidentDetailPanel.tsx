      ...
      >
        <div className="h-full bg-white shadow-2xl overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-auto p-4 space-y-4">
            {!incident ? (
              <p className="text-[#6B4423]">No incident selected.</p>
            ) : (
              <>
                ...
                <div>
                  ...
                  <p className="text-[#6B4423] leading-relaxed">{incident.description}</p>
                </div>
                ...
                <div className="bg-[#FAF3E8] rounded-lg p-3">
                  ...
                  <p className="text-[#6B4423]">{incident.timestamp.toLocaleString()}</p>
                </div>
          ...
          <div className="border-t border-gray-200 p-4 bg-[#FAF3E8]">
            <button
              className="w-full bg-[#800020] text-white py-2 px-4 rounded-lg hover:bg-[#6B1B2B] transition-colors"
              type="button"
              disabled={!incident}
            >
